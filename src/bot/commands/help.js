...
run: async (bot, message, args) => { //async
      ...
      message.react('887650847327158343');
                ...
                .setTitle(`Doggy Tickets`)
                .setThumbnail(message.guild.iconURL({ dynamic: true }))
                .setDescription(`_**Click On the Select Menu Below to __Swap__ help Pages**_\n🏠 - Home Page\n🎟️ - Doggy Commands ( tickets )\n❔ - Doggy Features\n📔 - About Me`)
                .setColor(`#0x2F3136`)

                const embed2 = new Discord.MessageEmbed()
                .setTitle(`Doggy Ticket Commands`)
                .setThumbnail(message.guild.iconURL({ dynamic: true }))
                .setDescription(`**__Here Are My Commands:__**\n\`setup,\` \`transcript,\` \`rename,\` \`remove,\` \`ping,\` \`open,\` \`close\``)
                .setColor(`#0x2F3136`)

                const embed3 = new Discord.MessageEmbed()
                .setTitle(`My Doggy Features`)
                .setThumbnail(message.guild.iconURL({ dynamic: true }))
                .setDescription(`**Hello, Im Doggy Tickets! You May Ask, What is diffent from me than the regular Multi-ticket system**? Well i have, Better emojis, Better buttons, And Lots of More Features!`)
                .setColor(`#0x2F3136`)
        ...
        .setValue('option2')
        .setEmoji("🎫")
        .setDescription('View Doggy Tickets Commands')
 ...
 b.reply.defer();
    ...
    collector.on("end", (b) => {
        ...
        .setFooter("Powered by Doggy's Development"))
    })
