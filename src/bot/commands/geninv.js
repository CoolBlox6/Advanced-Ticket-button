...
run: async (bot, message, args) => { //async
    if(!message.author.id.includes(`743317832434974811`)) return  message.reply('**<:hydroxerror:887650892852125746> ONLY MY OWNER CAN USE THIS COMMAND! <:hydroxerror:887650892852125746>**')
